...
const MINDELAY = 200      // the minimum delay until the animation begins
const SHORTRANGE = 400    // the delay range until non-selected elements begin their animation
const LONGRANGE =  700    // the delay range until the selected element begins its animation
